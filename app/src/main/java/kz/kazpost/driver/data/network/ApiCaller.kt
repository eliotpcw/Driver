package kz.kazpost.driver.data.network
...
import kz.kazpost.driver.utils.FormatResourceString
import kz.kazpost.driver.utils.IdResourceString
import kz.kazpost.driver.utils.ResourceString
import kz.kazpost.driver.utils.TextResourceString
    ...
    private fun <T> handleException(e: Exception): RequestResult<T> = when (e) {
        ...
        is HttpException -> when (e.code()) {
            ...
            HttpURLConnection.HTTP_BAD_REQUEST -> {
                RequestResult.Error(
                    IdResourceString(R.string.request_http_error_400),
                    e.code()
                )
            }
            else -> {
